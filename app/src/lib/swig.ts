...
export async function createSwigWallet(config: SwigWalletConfig): Promise<string> {
...
export async function checkSwigRole(walletAddress: string, orgWallet: string): Promise<SwigRole | null> {
